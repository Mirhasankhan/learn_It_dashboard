...
const EditTermsConditionsModal = ({ id }: { id: string }) => {
    const { data } = useGetAllTermsAndConditionsQuery(undefined);
    ...
    return (
        <DialogContent className='max-h-[80vh] md:min-w-xl overflow-x-hidden overflow-y-auto' showCloseButton>
            <h1 className="text-2xl font-semibold text-[#2D2D2D] pb-4">Edit Terms & conditions</h1>
...
export default EditTermsConditionsModal;