...
import { SaudiRiyal, TrendingUp } from "lucide-react";
...
export function MonthlyEarnings({ chartData = [], setType, isLoading, isFetching }: Props) {
      ...
      <CardContent className="pt-6">
        {isBusy ? (
          <div className="h-[280px] w-full flex flex-col justify-end gap-3 pb-4">
            <div className="flex items-end justify-between gap-3 h-[240px] px-4">
              {[40, 75, 55, 90, 65, 80, 45, 70, 85, 60, 95, 70].map((height, i) => (
          ...
          <div className="h-[280px] w-full flex flex-col items-center justify-center text-gray-400">
            <p className="text-sm">No monthly earnings recorded yet</p>
          </div>
        ) : (
          <div className="h-[280px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                <defs>
                  <linearGradient id="monthlyEarningGradient" x1="0" y1="0" x2="0" y2="1">
                ...
                <Bar
                  dataKey="earnings"
                  fill="url(#monthlyEarningGradient)"
                  radius={[6, 6, 0, 0]}
                  maxBarSize={45}
                />
              </BarChart>
